...
import node from "../../../images/logo/node.jpg";
import django from "../../../images/logo/django.png";
import mongoose from "../../../images/logo/mongoose.png";
import postgres from "../../../images/logo/postgres.png";
import prisma from "../../../images/logo/prisma.png";
...
const Backend = () => {
  ...
  const images = [node, django, mongoose, postgres, prisma];
  const dynamicText = ["Node", "Django", "Mongoose", "PostgreSQL", "Prisma"];
